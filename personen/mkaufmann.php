            ...
            <div id="colmid">
                <div id="colleft">
                    <div id="colleftleft">
                        <div id="contentwrap">
                            <div id="content">
                                  <h1>Quartierkommission Stadtteil 5</h1>
                                  <h2>Michel Kaufmann</h2>
                                  <p>
                                      <a href="http://www.dialognord.ch/">Dialog Nordquartier</a>
                                  </p>        
                            </div>
                        </div>
                        <div id="photocolumnwrap">
                            <div id="photocolumn">
                                <img src="/img/person/mkaufmann.jpg" alt="Michel Kaufmann">
                            </div>
                        </div>
                        <div id="leftmenuwrap">
                            <div id="leftmenu">
